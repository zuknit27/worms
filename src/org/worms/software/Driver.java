...
public class Driver 
{
	public static void main(String[] args)
	{
		...
		System.out.println("\n\nTest 3:");
		System.out.println(s1.getName() + "'s task is " + s1.getTaskList().get(0));
		System.out.println(s2.getName() + "'s task is " + s2.getTaskList().get(0));
		System.out.println(s3.getName() + "'s task is " + s3.getTaskList().get(0));
